	...
	return (
		<div className="flex flex-col gap-8">
			<div className="w-9/12 mx-auto">
				<h3 className="text-2xl mb-2 font-bold text-white">What is CORS?</h3>
			...
			<div className="w-9/12 mx-auto">
				<h3 className="text-2xl mb-2 font-bold text-white">Why are you using firebase? What other options do you have to implement authentication?</h3>
			...
			<div className="w-9/12 mx-auto">
				<h3 className="text-2xl mb-2 font-bold text-white">How does the private route work?</h3>
			...
			<div className="w-9/12 mx-auto">
				<h3 className="text-2xl mb-2 font-bold text-white">What is Node? How does Node work?</h3>
