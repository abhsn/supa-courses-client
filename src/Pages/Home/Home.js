	...
	return (
		<div className="hero z-0">
			<div className="hero-content flex-col lg:flex-row-reverse">
				<img src="https://phero-web.nyc3.cdn.digitaloceanspaces.com/website-prod-images/public/files/1622955725643.png" className="max-w-sm rounded-lg shadow-2xl" alt='Human sitting on a chair' />
				<div>
